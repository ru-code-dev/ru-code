...
import { injectAppearanceBootstrap } from "./ru-code/appearanceBootstrapHtml.ts"; // ru-code: stamp theme/palette into served HTML
...
export const staticAndDevRouteLayer = HttpRouter.add(
  ...
  Effect.gen(function* () {
    ...
    // ru-code: "/" (and any direct index.html hit) also carries the locale + theme seed.
