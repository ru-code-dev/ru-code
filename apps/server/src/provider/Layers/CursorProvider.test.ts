...
const cursorAcpDiscoveryFailedMessage = [
  ...
  `Cursor CLI setup may be incomplete; install or enable Cursor CLI, restart ${APP_NAME}, and try again.`,
...
const cursorCliCommandMissingMessage = [
  ...
  `Install or enable Cursor CLI, make sure \`${missingCursorBinaryPath}\` is on the PATH, then restart ${APP_NAME}.`,
  "See https://cursor.com/docs/cli/installation.",
].join(" ");
