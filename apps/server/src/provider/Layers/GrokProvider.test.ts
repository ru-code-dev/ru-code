...
// ru-code: grok is a disabled adapter — skip its provider suites until re-enabled.
describe.skip("buildInitialGrokProviderSnapshot", () => {
...
// ru-code: grok disabled — skip this suite too (remove wrapper + EOF `});` to restore).
describe.skip("checkGrokProviderStatus (grok disabled)", () => {
