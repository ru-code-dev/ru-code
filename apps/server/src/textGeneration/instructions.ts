// ru-fork: the instruction lines our text-generation calls send to the CLI. Kept here
// as a single source so the Stats feature can recognize these one-shot calls in qwen's
// transcripts (apps/server/src/ru-fork/stats/serviceSignatures.ts) without the two
