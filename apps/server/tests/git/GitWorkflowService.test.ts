...
import { GitManager } from "../../src/git/GitManager.ts";
import {
  GitWorkflowService,
  layer as GitWorkflowServiceLayer,
} from "../../src/git/GitWorkflowService.ts";
import { GitVcsDriver } from "../../src/vcs/GitVcsDriver.ts";
import { VcsDriverRegistry, type VcsDriverRegistryShape } from "../../src/vcs/VcsDriverRegistry.ts";
