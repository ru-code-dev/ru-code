...
import { ProjectSetupScriptRunner } from "../../../src/project/Services/ProjectSetupScriptRunner.ts";
import { ProjectSetupScriptRunnerLive } from "../../../src/project/Layers/ProjectSetupScriptRunner.ts";
...
describe("ProjectSetupScriptRunner", () => {
  ...
  it("opens the deterministic setup terminal with worktree env and writes the command", async () => {
    ...
    expect(open).toHaveBeenCalledWith({
      ...
      worktreePath: "/repo/worktrees/a",
      env: {
        RU_FORK_PROJECT_ROOT: "/repo/project",
        RU_FORK_WORKTREE_PATH: "/repo/worktrees/a",
      },
    });
