...
import type { ClaudeAdapterShape } from "../../../src/provider/Services/ClaudeAdapter.ts";
import type { CodexAdapterShape } from "../../../src/provider/Services/CodexAdapter.ts";
import type { CursorAdapterShape } from "../../../src/provider/Services/CursorAdapter.ts";
import type { OpenCodeAdapterShape } from "../../../src/provider/Services/OpenCodeAdapter.ts";
...
import type { TextGenerationShape } from "../../../src/textGeneration/TextGeneration.ts";
import { ProviderAdapterRegistryLive } from "../../../src/provider/Layers/ProviderAdapterRegistry.ts";
import { makeManualOnlyProviderMaintenanceCapabilities } from "../../../src/provider/providerMaintenance.ts";
