// ru-fork: improvements-branch-3 GUARD tests (green now) — protect the parts we're about to change.
...
import { overlayFingerprint, type OverlayServerEntry } from "@ru-fork/mcp-core";
import { DEFAULT_TOOL_POLICY, type McpToolPolicy } from "@t3tools/contracts";
import { describe, expect, it } from "vitest";

import { buildServerEntry } from "../../../src/ru-fork/mcp/McpOverlay.ts";
