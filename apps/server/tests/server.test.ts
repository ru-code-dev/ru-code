...
import { resolveAttachmentRelativePath } from "../src/attachmentPaths.ts";
import {
  CheckpointDiffQuery,
  type CheckpointDiffQueryShape,
} from "../src/checkpointing/Services/CheckpointDiffQuery.ts";
import { GitManager, type GitManagerShape } from "../src/git/GitManager.ts";
...
} from "../src/serverLifecycleEvents.ts";
import {
  ServerRuntimeStartup,
  type ServerRuntimeStartupShape,
} from "../src/serverRuntimeStartup.ts";
...
import { ProjectFaviconResolverLive } from "../src/project/Layers/ProjectFaviconResolver.ts";
import {
  ProjectSetupScriptRunner,
  ProjectSetupScriptRunnerError,
  type ProjectSetupScriptRunnerShape,
} from "../src/project/Services/ProjectSetupScriptRunner.ts";
import {
  RepositoryIdentityResolver,
  type RepositoryIdentityResolverShape,
} from "../src/project/Services/RepositoryIdentityResolver.ts";
import {
  ServerEnvironment,
  type ServerEnvironmentShape,
} from "../src/environment/Services/ServerEnvironment.ts";
import { WorkspaceEntriesLive } from "../src/workspace/Layers/WorkspaceEntries.ts";
import { WorkspaceFileSystemLive } from "../src/workspace/Layers/WorkspaceFileSystem.ts";
...
const buildAppUnderTest = (options?: {
  ...
  Effect.gen(function* () {
    ...
    const config: ServerConfigShape = {
      ...
      // ru-fork: required field on ServerConfigShape; "" = no prefix.
      basePath: "",
      ...options?.config,
    };
    ...
    const servedRoutesLayer = HttpRouter.serve(makeRoutesLayer, {
      ...
      // ru-fork: ProcessDiagnostics/TraceDiagnostics services removed from src — mock layers dropped
...
it.layer(NodeServices.layer)("server router seam", (it) => {
  ...
  it.effect.skip("reports unauthenticated session state without requiring auth", () =>
    Effect.gen(function* () {
      yield* buildAppUnderTest();
  ...
  it.effect.skip("includes CORS headers on remote websocket-token auth failures", () =>
    Effect.gen(function* () {
      yield* buildAppUnderTest();
  ...
  it.effect.skip("accepts websocket rpc handshake with a bootstrapped browser session cookie", () =>
    Effect.gen(function* () {
      yield* buildAppUnderTest();
  ...
  it.effect.skip("proxies browser OTLP trace exports through the server", () =>
    Effect.gen(function* () {
  ...
  it.effect.skip("routes websocket rpc server.upsertKeybinding", () =>
    Effect.gen(function* () {
  ...
  it.effect.skip("routes websocket rpc server.removeKeybinding", () =>
    Effect.gen(function* () {
      const rule: KeybindingRule = {
        command: "terminal.toggle",
        key: "ctrl+k",
  ...
  it.effect.skip("routes websocket rpc subscribeServerConfig streams snapshot then update", () =>
    Effect.gen(function* () {
      const providers = [
        {
          instanceId: ProviderInstanceId.make("codex"),
  ...
  it.effect.skip("routes websocket rpc subscribeServerConfig emits provider status updates", () =>
    Effect.gen(function* () {
      const nextProviders = [
        {
          instanceId: ProviderInstanceId.make("codex"),
  ...
  it.effect.skip("routes websocket rpc projects.searchEntries", () =>
    Effect.gen(function* () {
      const fs = yield* FileSystem.FileSystem;
      const path = yield* Path.Path;
  ...
  it.effect.skip("routes websocket rpc projects.searchEntries excludes gitignored files", () =>
    Effect.gen(function* () {
      const fs = yield* FileSystem.FileSystem;
      const path = yield* Path.Path;
  ...
  it.effect.skip("routes websocket rpc projects.searchEntries errors", () =>
    Effect.gen(function* () {
      yield* buildAppUnderTest();
  ...
  it.effect.skip("routes websocket rpc projects.writeFile", () =>
    Effect.gen(function* () {
      const fs = yield* FileSystem.FileSystem;
      const path = yield* Path.Path;
  ...
  it.effect.skip("creates a missing workspace root during websocket project.create dispatch", () =>
    Effect.gen(function* () {
      const fs = yield* FileSystem.FileSystem;
      const path = yield* Path.Path;
  ...
  it.effect.skip("routes websocket rpc projects.writeFile errors", () =>
    Effect.gen(function* () {
      const fs = yield* FileSystem.FileSystem;
      const workspaceDir = yield* fs.makeTempDirectoryScoped({ prefix: "t3-ws-project-write-" });
  ...
  it.effect.skip("routes websocket rpc shell.openInEditor", () =>
    Effect.gen(function* () {
  ...
  it.effect.skip("routes websocket rpc shell.openInEditor errors", () =>
    Effect.gen(function* () {
  ...
  it.effect.skip("routes websocket rpc git methods", () =>
    Effect.gen(function* () {
      yield* buildAppUnderTest({
        layers: {
          gitManager: {
  ...
  it.effect.skip("routes websocket rpc git.pull errors", () =>
    Effect.gen(function* () {
  ...
  it.effect.skip("routes websocket rpc orchestration methods", () =>
    Effect.gen(function* () {
      const now = "2026-01-01T00:00:00.000Z";
      const snapshot = {
        snapshotSequence: 1,
  ...
  it.effect.skip("enriches replayed project events with repository identity metadata", () =>
    Effect.gen(function* () {
  ...
  it.effect.skip("stops the provider session and closes thread terminals after archive", () =>
    Effect.gen(function* () {
  ...
  it.effect.skip(
    "checks session status before archiving removes the thread from active lookups",
    () =>
      Effect.gen(function* () {
  ...
  it.effect.skip("archives without dispatching session stop when the thread has no session", () =>
    Effect.gen(function* () {
  ...
  it.effect.skip("archives and still closes terminals when session stop fails", () =>
    Effect.gen(function* () {
  ...
  it.effect.skip("archives and still closes terminals when session stop defects", () =>
    Effect.gen(function* () {
  ...
  it.effect.skip("records setup-script failures without aborting bootstrap turn start", () =>
    Effect.gen(function* () {
      const dispatchedCommands: Array<OrchestrationCommand> = [];
      const createWorktree = vi.fn(
        (_: Parameters<GitVcsDriver.GitVcsDriverShape["createWorktree"]>[0]) =>
  ...
  it.effect.skip("cleans up created bootstrap threads when worktree creation defects", () =>
    Effect.gen(function* () {
      const dispatchedCommands: Array<OrchestrationCommand> = [];
      const createWorktree = vi.fn(
        (_: Parameters<GitVcsDriver.GitVcsDriverShape["createWorktree"]>[0]) =>
  ...
  it.effect.skip("routes websocket rpc terminal methods", () =>
    Effect.gen(function* () {
      const snapshot = {
        threadId: "thread-1",
        terminalId: "default",
  ...
  it.effect.skip("routes websocket rpc terminal.write errors", () =>
    Effect.gen(function* () {
