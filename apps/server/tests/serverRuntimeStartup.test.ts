...
it("uses the canonical CLI default for auto-bootstrapped model selection", () => {
...
it.effect.skip("launchStartupHeartbeat does not block the caller while counts are loading", () =>
  Effect.scoped(
    Effect.gen(function* () {
