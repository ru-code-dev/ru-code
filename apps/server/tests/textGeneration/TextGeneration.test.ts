...
import type { ProviderInstanceRegistryShape } from "../../src/provider/Services/ProviderInstanceRegistry.ts";
import type { TextGenerationShape } from "../../src/textGeneration/TextGeneration.ts";

import { makeTextGenerationFromRegistry } from "../../src/textGeneration/TextGeneration.ts";
