...
import { runVcsDriverContractSuite } from "../../src/vcs/testing/VcsDriverContractHarness.ts";

const ServerConfigLayer = ServerConfig.layerTest(process.cwd(), {
  prefix: "t3-git-vcs-contract-",
});
// ru-fork: driver gates `refreshStatusUpstreamIfStale` on interval=0.
// Contract suite exercises legacy fetch behavior — opt in with non-zero.
