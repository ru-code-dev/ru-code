...
import {
  VcsProcess,
  type VcsProcessInput,
  type VcsProcessOutput,
} from "../../src/vcs/VcsProcess.ts";
import { VcsProjectConfig } from "../../src/vcs/VcsProjectConfig.ts";
import {
  VcsDriverRegistry,
  make as makeVcsDriverRegistry,
} from "../../src/vcs/VcsDriverRegistry.ts";
