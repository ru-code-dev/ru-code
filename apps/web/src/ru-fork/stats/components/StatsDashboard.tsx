 ...
 *
 * Read-only, fake-data view (no server). Composes the filter bar, KPI strip and
 * the widget grid; every card can expand into a drill-down sheet, and the
 * sessions table opens a per-session sheet. All numbers derive from {@link
