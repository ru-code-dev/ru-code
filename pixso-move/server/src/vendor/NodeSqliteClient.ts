/**
 * pixso-move: vendored verbatim from apps/server/src/persistence/NodeSqliteClient.ts
 * (ru-fork @ b3a4207d). Keep in sync; do not edit. Exempt from the 150-LOC cap
 * and from coverage (upstream infra). See specs/conventions.md §2.3.
 *
