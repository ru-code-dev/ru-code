...
import { buildLayout, type Layout, type Prepared, prepareArtifacts } from "../harness/artifacts.ts";
import { readSentinel } from "../harness/daemon.ts";
import {
  getFreePort,
  getHealthz,
  log,
...
const PIN_DIR = NodePath.resolve(REPO_ROOT, "ru-code/e2e/tests-pins");
